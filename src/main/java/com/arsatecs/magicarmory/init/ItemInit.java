...
public class ItemInit {
    ...
    private static final FoodProperties ELIXIR_OF_FLAME_PROPS = new FoodProperties.Builder()
            .effect(() -> new MobEffectInstance(MobEffects.FIRE_RESISTANCE, 100000, 0), 1.0f).build();

    public static final RegistryObject<PotionItem> ELIXIR_OF_FLAME = ITEMS.register(
            "elixir_of_flame",
            () -> new PotionItem(new PotionItem.Properties().tab(CreativeModeTab.TAB_MISC).food(ELIXIR_OF_FLAME_PROPS))
    );
